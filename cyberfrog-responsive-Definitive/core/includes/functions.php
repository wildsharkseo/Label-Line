...
<?php }
    ...
    function responsive_widgets_init() {
        ...
        register_sidebar(array(
            ...
            'name' => __('Super Search', 'responsive'),

            'description' => __('super-search', 'responsive'),
        ...
        register_sidebar(array(
		 ...
		 register_sidebar(array(
            ...
            'name' => __('foot-1', 'responsive'),

            'description' => __('foot-1', 'responsive'),
		 ...
		 register_sidebar(array(
            ...
            'name' => __('foot-2', 'responsive'),

            'description' => __('foot-2', 'responsive'),
